...
public class EditProductController implements ActionListener {
    ...
    public EditProductController(EditProductView epv, Product pr, int id, TableModel model, int row) {
        ...
        editProductView.getQuantityTextField().setText(product.getPrice().toString());
        editProductView.getPriceTextField().setText(product.getQuantity().toString());
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equalsIgnoreCase("cancel")) {
            ...
            if (price != null && !price.equalsIgnoreCase("") && quantity != null && !quantity.equalsIgnoreCase("")
                ...
                JOptionPane.showMessageDialog(editProductView, "Fields cannot be empty ", "Error Message ", JOptionPane.ERROR_MESSAGE);
            }
        }
