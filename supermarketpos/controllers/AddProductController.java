            ...
            if (price != null && !price.equalsIgnoreCase("") && quantity != null && !quantity.equalsIgnoreCase("")
                ...
                try {
                    ...
                    if (p > 0 && q > 0) {
                        ...
                        JOptionPane.showMessageDialog(view, "Price and Quantity must be more than 0", "Error Message ", JOptionPane.ERROR_MESSAGE);
                    }
                ...
                JOptionPane.showMessageDialog(view, "Fields cannot be empty ", "Error Message ", JOptionPane.ERROR_MESSAGE);
            }
